...
<article  class="card" style="width: 30rem; background-color: #242527cc; padding: 3rem; border: 1px #343a40; margin: 5% auto; height: auto">
    <form action="verifyUserRegister" method="post">
    ...
    <button type="submit" class="btn btn-primary" style="width: 100%; background-color: #343a40; color: white;">Registrar</button>
    {if $msj != ""}
